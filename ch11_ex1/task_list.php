            ...
            <?php if (!empty($task_to_modify)) : ?>
                ...
                <form action="." method="post" >
                    <?php foreach( $task_list as $task ) : ?>
                        <input type="hidden" name="tasklist[]" value="<?php echo $task; ?>"/>
                    <?php endforeach; ?>
                    <label for="modifiedtask">Task:</label>
                    <input id="modifiedtask" type="text" name="modifiedtask" value="<?php echo $task_to_modify; ?>" /><br />
                    <input type="hidden" name="modifiedtaskid" value="<?php if (isset($task_index)) echo $task_index; ?>" />
                    <label>&nbsp;</label>
